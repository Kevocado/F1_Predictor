...
GuestAuthMiddleware and api/routes.py's _admin_only dependency. Ported
directly from PL_Predictor's own tests/test_auth.py: same pattern, same
reasoning (a minimal standalone FastAPI app rather than the real
`main.app`, whose lifespan starts the real live poller)."""
...
from f1_predictor.api import auth as auth_mod
