...
access control now that it has no login gate: the one write endpoint
(retrain) 404s unconditionally under PUBLIC_MODE regardless of who's
asking, since the site is otherwise a plain public read-only page with
nothing a password would protect."""
